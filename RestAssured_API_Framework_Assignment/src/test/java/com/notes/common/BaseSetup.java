package com.notes.common;import java.io.File;
...
public class BaseSetup {
	...
	String extendReportPath = "/test-output/ExtentReportResults_Notescom.html";
	...
	public void SetUp() {
		...
		htmlReporter.config().setDocumentTitle("Extend Report For Notes Tests");
		htmlReporter.config().setReportName("Extend Report For Notes Tests");
